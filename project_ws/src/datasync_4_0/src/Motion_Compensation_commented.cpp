 ...
 *      (pas de version brute publiée dans cette version)
...
public:
    ...
    ~EventVisualizer() override = default;
...
private:
    ...
    void data_process() {
        ...
        // Pas d’image brute publiée : uniquement l’image compensée.

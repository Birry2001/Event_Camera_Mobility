...
class EventSegmentationNode(Node):
    ...
    def _on_images(self, time_msg: Image, count_msg: Image) -> None:
        ...
        # NOTE: ton time_img doit déjà correspondre à la "time image" (moyenne des timestamps)
        # et idéalement à la version normalisée du papier (Eq.11). :contentReference[oaicite:6]{index=6}
        ...
        vis[bg_mask] = self._vis_bg_bgr
        vis[fg_mask] = self._vis_fg_bgr  # fg overrides bg
